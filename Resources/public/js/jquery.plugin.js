 ...
 */
(function($, jQuery) {
    jQuery.fn.simpleThingsJsValidation = function (options) {
        options = jQuery.extend({}, jQuery.fn.simpleThingsJsValidation.defaults, options);
    ...
    jQuery.fn.simpleThingsJsValidation.defaults = {
        validator: null,
        constraints: null,
